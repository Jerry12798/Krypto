...
class Eco(commands.Cog, name="Eco", description="Economy & Setup Commands"):
	...
	async def apply(self, ctx):
		...
		async for m in collection.find({"Guild": ctx.guild.id}, {"_id": 0}):
			check = m["Guild"]
		if check is None:
			embed = discord.Embed(title="__**Apply Error**__", description=f"**{ctx.guild}** has not Registered with {self.bot.user.mention} to use Currency Exchange.", timestamp=datetime.now(), color=0xff0000)
	...
	async def shop(self, ctx, *, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Shop Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		if not memberz is None:
			async for m in collection_4.find({"Guild": ctx.guild.id, "Member": memberz.id}, {"_id": 0}):
				recipent = m["Member"]
			if recipent is None:
				embed = discord.Embed(title="__**Shop Error**__", description=f"**{memberz}** has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
				embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
				await ctx.send(embed=embed)
				return
		shop = None
		...
		if not memberz is None:
			...
			async for m in grab_shop:
				...
				price = m["Price"]
			if shop is None:
				embed = discord.Embed(title="__**Shop**__", description=f"{memberz.display_name} has `0` Items in their Shop..", timestamp=datetime.now(), color=0xff0000)
				embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		...
		async for m in grab_shop:
			...
			price = m["Price"]
		if shop is None:
			embed = discord.Embed(title="__**Shop**__", description=f"{ctx.guild} has `0` Items in their Shop..", timestamp=datetime.now(), color=0xff0000)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			await ctx.message.delete()
	...
	async def bag(self, ctx, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Bag Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		async for m in grab_bag:
			bag = m["Items"]
		if bag is None:
			embed = discord.Embed(title="__**Bag**__", description=f"{memberz} has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
			embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
		...
		for m in bag:
			...
			if item_count == 10:
				...
				order = ""
		if len(bag) <= 0:
			embed = discord.Embed(title="__**Bag**__", description=f"{memberz} has `0` Items..", timestamp=datetime.now(), color=0xff0000)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
			embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
	...
	async def buy(self, ctx, queue:int=None, *, memberz: discord.Member=None):
		if queue is None:
			embed = discord.Embed(title="__**Purchase Error**__", description=f"You must Specify the Item Index &/or Member.\n`{self.bot.prefix}buy <Item Index>` *or* `{self.bot.prefix}buy <Item Index> <Mention Member>`", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		collection = self.bot.db["Eco_member_balance"]
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Purchase Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		if not memberz is None:
			...
			async for m in collection.find({"Guild": ctx.guild.id, "Member": memberz.id}, {"_id": 0}):
				recipent = m["Member"]
			if recipent is None:
				embed = discord.Embed(title="__**Purchase Error**__", description=f"**{memberz}** has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
				embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
				await ctx.send(embed=embed)
				return
		shop = None
		...
		if not memberz is None:
			...
			async for m in grab_shop:
				...
				price = m["Price"]
			if shop is None:
				embed = discord.Embed(title="__**Purchase Error**__", description=f"{memberz.display_name} has `0` Items in their Shop..", timestamp=datetime.now(), color=0xff0000)
				embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
				embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
				embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
				await ctx.send(embed=embed)
			...
			embed = discord.Embed(title="__**Purchase Successful**__", description=f"You have Successfully Purchased **{item}** from **{memberz.user.mention}** for **{total}**.", timestamp=datetime.now(), color=0xac5ece)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			embed_2 = discord.Embed(title="__***Purchase***__", timestamp=datetime.now(), color=0xff0000)
			embed_2.set_author(name=f"{memberz}", icon_url=memberz.display_avatar.replace(format="png", static_format="png"))
		...
		async for m in grab_shop:
			...
			price = m["Price"]
		if shop is None:
			embed = discord.Embed(title="__**Purchase Error**__", description=f"{ctx.guild} has `0` Items in their Shop..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		if len(shop) <= 0:
		...
		await collection_4.update_one({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"$set":{"Items": order}})
		embed = discord.Embed(title="__**Purchase Successful**__", description=f"You have Successfully Purchased ***{item}*** for **{price[queue-1]}**.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		embed_2 = discord.Embed(title="__***Purchase***__", timestamp=datetime.now(), color=0xff0000)
		embed_2.add_field(name="__**:newspaper: Item:**__", value=f"{item}", inline=False)
	...
	async def balance(self, ctx, *, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Balance Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		async for m in collection_2.find({"Guild": ctx.guild.id, "Member": memberz.id}, {"_id": 0}):
			recipent = m["Member"]
		if recipent is None:
			embed = discord.Embed(title="__**Balance Error**__", description=f"**{memberz}** has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		counter = "N/A"
		...
		async for m in collection_2.find({"Guild": ctx.guild.id}, {"_id": 0}).sort("Currency", pymongo.DESCENDING):
			...
			if member == memberz.id:
				...
				await ctx.message.delete()
				return
		embed = discord.Embed(title="__**User Balance**__", description=f"{memberz.display_name} has not Applied for an Account..", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
	...
	async def gbalance(self, ctx):
		...
		async for m in collection_2.find({"Guild": ctx.guild.id}, {"_id": 0}):
			...
			if guild == ctx.guild.id:
				...
				await ctx.message.delete()
				return
		embed = discord.Embed(title="__**Server Balance**__", description=f"{ctx.guild} has not Registered.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def daily(self, ctx):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Rewards Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	@daily.error
	...
	#security = commands.Group(name="security", description="Safety Deposit Box & Savings Account Commands")
	...
	async def rent(self, ctx):
		...
		async for m in collection.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Rent Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
	...
	async def storage(self, ctx, *, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Storage Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		async for m in collection_4.find({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"_id": 0}):
			recipent = m["Member"]
		if recipent is None:
			embed = discord.Embed(title="__**Storage Error**__", description=f"You have not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		async for m in collection_2.find({"Guild": ctx.guild.id}, {"_id": 0}).sort("Currency", pymongo.DESCENDING):
			...
			if member == memberz.id:
				...
				items = m["Items"]
		if items is None:
			embed = discord.Embed(title="__**User Storage**__", description=f"{memberz.display_name} has not Rented a Security Box or Savings Account..", timestamp=datetime.now(), color=0xac5ece)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
			embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
		...
		if len(items) <= 0 and money <= 0:
			embed = discord.Embed(title="__**User Storage**__", description=f"{memberz.display_name} has nothing in their Security Box or Savings Account..", timestamp=datetime.now(), color=0xac5ece)
			embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
			embed.set_author(name=f"{memberz}", icon_url=str(memberz.display_avatar.replace(format="png", static_format="png")))
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
	...
	async def withdraw(self, ctx, amount: int=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Withdraw Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		async for m in collection.find({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"_id": 0}):
	...
	async def deposit(self, ctx, amount: int=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Deposit Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		async for m in collection.find({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"_id": 0}):
	...
	#manage = commands.Group(name="manage", description="Shop Configuration & Item/Currency Management Commands")
	...
	async def sell(self, ctx, price:int=None, *, item: int=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Sell Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		async for m in collection_4.find({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"_id": 0}):
	...
	async def rsell(self, ctx, *, queue: int=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Remove Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
	...
	async def csell(self, ctx):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Clear Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
	...
	async def transfer(self, ctx, amount: int=None, *, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Transfer Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		async for m in collection.find({"Guild": ctx.guild.id, "Member": memberz.id}, {"_id": 0}):
			recipent = m["Member"]
		if recipent is None:
			embed = discord.Embed(title="__**Transfer Error**__", description=f"**{memberz}** has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		await collection.delete_one(old_log)
		await collection.insert_one(log)
		embed = discord.Embed(title=f"__**Transfer Complete**__", description=f"*{memberz.display_name}* has Received your Transfer of **{amount}**.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def give(self, ctx, amount: int=None, *, memberz: discord.Member=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Gift Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		async for m in collection.find({"Guild": ctx.guild.id, "Member": memberz.id}, {"_id": 0}):
			recipent = m["Member"]
		if recipent is None:
			embed = discord.Embed(title="__**Gift Error**__", description=f"**{memberz}** has not Applied for an Account..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		...
		async for m in grab_members:
			...
			if server_members == memberz.id:
				...
				if len(receiver_bag) > Bag_Limit:
					embed = discord.Embed(title="__**Bag Full**__", description=f"*{memberz.display_name}* already has **{Bag_Limit}** Items in their Bag.", timestamp=datetime.now(), color=0xff0000)
					embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
					await ctx.send(embed=embed)
					return
		...
		embed = discord.Embed(title=f"__**Gift Sent**__", description=f"*{memberz.display_name}* has Received *{item}*.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def drop(self, ctx, amount: int=None):
		...
		async for m in collection_3.find({"Guild": ctx.guild.id}, {"_id": 0}):
			server = m["Guild"]
		if server is None:
			embed = discord.Embed(title="__**Drop Error**__", description=f"**{ctx.guild}** hasn't Registered with {self.bot.user.mention} to use Currency Exchange..", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
	...
	#admin_eco = commands.Group(name="admin", description="Economy Admin & Setup Commands")
	...
	async def register(self, ctx):
		...
		log ["Price"] = []
		await collection.insert_one(log)
		embed = discord.Embed(title="__**Server Registered**__", description=f"You have Successfully Registered ***{ctx.guild}*** for Currency Exchange.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def uwithdraw(self, ctx, queue: int=None, *, member: discord.Member=None):
		...
		await collection.update_one({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"$set":{"Currency": ending_balance}})
		embed = discord.Embed(title="__**Withdraw**__", description=f"**{queue}** has been Withdrawed from ***{member}***.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
	...
	async def udeposit(self, ctx, queue: int=None, *, member: discord.Member=None):
		...
		ending_balance = balance + queue
		await collection.update_one({"Guild": ctx.guild.id, "Member": ctx.author.id}, {"$set":{"Currency": ending_balance}})
		embed = discord.Embed(title="__**Deposit**__", description=f"**{queue}** has Deposited to ***{member}*** .", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png", static_format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		if not mod_log is None:
			await mod_log.send(embed=embed)
	...
	async def ritem(self, ctx, *, queue: int=None):
		...
		async for m in grab_snippets:
			...
			price += m["Price"]
		if items is None:
			embed = discord.Embed(title="__**Remove Error**__", description=f"There's nothing in {ctx.guild}'s Shop.", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		if len(items) <= 0:
		...
		price.pop(queue-1)
		await collection_2.update_one({"Guild": ctx.guild.id}, {"$set":{"Items": items, "Price": price}})
		embed = discord.Embed(title=f"__**Item Removed**__", description=f"*{item}* has been Removed from the Shop.", timestamp=datetime.now(), color=0xff0000)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	@ritem.error
	...
	async def cshop(self, ctx):
		...
		if server is None:
			...
			return
		if items is None:
			embed = discord.Embed(title="__**Clear Error**__", description=f"There's nothing in {ctx.guild}'s Shop.", timestamp=datetime.now(), color=0xff0000)
			embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
			await ctx.send(embed=embed)
			return
		if len(items) <= 0:
		...
		embed = discord.Embed(title=f"__**Shop Cleared**__", description=f"All Items has been Cleared from {ctx.guild}'s Shop.", timestamp=datetime.now(), color=0xff0000)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	@cshop.error
	...
	async def lbag(self, ctx, amount: int=None):
		...
		await collection.delete_one(old_log)
		await collection.insert_one(log)
		embed = discord.Embed(title="__**Bag Storage**__", description=f"You have Changed {ctx.guild}'s Bag Limit to **{amount}** Slots.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def lbox(self, ctx, amount: int=None):
		...
		await collection.delete_one(old_log)
		await collection.insert_one(log)
		embed = discord.Embed(title="__**Security Box Storage**__", description=f"You have Changed {ctx.guild}'s Security Box Limit to **{amount}** Slots.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def ustart(self, ctx, amount: int=None):
		...
		await collection.delete_one(old_log)
		await collection.insert_one(log)
		embed = discord.Embed(title="__**User Start Balance**__", description=f"You have Changed {ctx.guild}'s User Start Balance to **{amount}**.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
	...
	async def sstart(self, ctx, amount: int=None):
		...
		await collection.delete_one(old_log)
		await collection.insert_one(log)
		embed = discord.Embed(title="__**Server Start Balance**__", description=f"You have Changed {ctx.guild}'s Start Balance to **{amount}**.", timestamp=datetime.now(), color=0xac5ece)
		embed.set_thumbnail(url=ctx.guild.icon.replace(format="png"))
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.display_avatar.replace(format="png", static_format="png"))
		await ctx.send(embed=embed)
		await ctx.message.delete()
