...
async def play_aki(self, ctx):
	...
	async def go_back(previous_state):
		try:
			...
			embed = discord.Embed(title="__**Akinator Error**__", description=f"I can't go back any further!", timestamp=datetime.utcnow(), color=0xff0000)
		...
		while self.bot.aki.progression <= 80:
			...
			if answer.content.lower() == "back" or answer.content.lower() == "b":
				...
				try:
					...
					embed = discord.Embed(title="__**Akinator Error**__", description=f"Akinator has No More Questions!", timestamp=datetime.utcnow(), color=0xff0000)
					embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
					await ctx.send(embed=embed)
					...
					embed = discord.Embed(title="__**Akinator Error**__", description=f"Akinator is currently down!", timestamp=datetime.utcnow(), color=0xff0000)
					embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
					await ctx.send(embed=embed)
					...
					embed = discord.Embed(title="__**Akinator Error**__", description=f"Akinator has faced a technical error!", timestamp=datetime.utcnow(), color=0xff0000)
					embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
					await ctx.send(embed=embed)
	...
	if ctx.author.id in self.bot.playing_aki:
		embed = discord.Embed(title="__**Akinator Error**__", description=f"You already have an active game going.", timestamp=datetime.utcnow(), color=0xff0000)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
		await ctx.send(embed=embed)
		return
	...
	if answer.content.lower() == "yes" or answer.content.lower().lower() == "y":
		embed = discord.Embed(title="__**Akinator**__", description=f"I love playing with you!", timestamp=datetime.utcnow(), color=0xac5ece)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
		await ctx.send(embed=embed)
	if answer.content.lower() == "no" or answer.content.lower().lower() == "n":
		embed = discord.Embed(title="__**Akinator**__", description=f"Oof.. hopefully I'll have better luck next time.", timestamp=datetime.utcnow(), color=0xac5ece)
		embed.set_footer(text=f"{ctx.author}", icon_url=ctx.author.avatar_url_as(format=None, static_format="png"))
		await ctx.send(embed=embed)